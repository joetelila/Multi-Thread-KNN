...
public:
 ...
 // This is the constructor. Will be called when the constructor is instantiated.
 // We initialize our timer inside the constructor.
...
// This is the deconstructor. Will be called when the object is destroyed.
// We calculate the total time elapsed inside the deconstructor.
  ~utimer() {
    stop =
